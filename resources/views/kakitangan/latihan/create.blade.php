                        ...
                        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="date" name="mula"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                                    value="{{ old('mula', date('Y-m-d')) }}" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="tamat"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                                    value="{{ old('tamat', date('Y-m-d')) }}" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="tempat"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                                    value="{{ old('tempat', 'CIAST Shah Alam') }}" required>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="penganjur"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                                    value="{{ old('penganjur', 'Penganjur') }}" required>
                            </div>
