        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('apc.update', $apc->id) }}" method="POST">
                        @csrf
                        @method('PUT') 
                        ...
                        <table class="w-full table-auto">
                            ...
                            <tr>
                                ...
                                <td class="p-2 bg-yellow-100">
                                    <input type="number" name="tahunterima" class="p-2 border rounded"  min="1900" max="2100" required value="{{ $apc->tahunterima ? $apc->tahunterima : '' }}">
                            ...
                            <tr>
                                ...
                                <td class="p-2 flex gap-2 mt-6">
                                    ...
                                    <a href="{{ route('apc.create', ['id' => $apc->id_kakitangan]) }}"
