        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('surat_akuan.update', $surat->id) }}"
                        onsubmit="return confirm('Adakah anda ingin mengemaskini?');">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select name="pesakit"
                                    ...
                                    @foreach($pesakit as $p)
                                        <option value="{{ $p->id }}" {{ $surat->pesakit == $p->id ? 'selected' : '' }}>
                                            {{ $p->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="wad"
                                    ...
                                    @foreach($wad as $w)
                                        <option value="{{ $w->id }}" {{ $surat->wad == $w->id ? 'selected' : '' }}>
