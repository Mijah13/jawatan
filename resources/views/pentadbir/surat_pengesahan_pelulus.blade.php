        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-6">Cari Pegawai Yang Tanda Tangan Surat Pengesahan</h3>
                    ...
                    <!-- Add Form -->
                    <form method="POST" action="{{ route('pentadbir.surat_pengesahan_pelulus') }}" class="mb-8">
                        @csrf
                        <div class="space-y-4">
                            <div>
           ...
           focus:ring-2 focus:ring-blue-500">
                    ...
                    <h4 class="text-md font-semibold mb-4">Senarai Pegawai Pengesah GL</h4>
