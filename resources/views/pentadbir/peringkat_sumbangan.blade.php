        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-6">Tambah Maklumat - Peringkat Sumbangan</h3>
                    ...
                    <!-- Add Form -->
                    <form method="POST" action="{{ route('pentadbir.peringkat_sumbangan') }}" class="mb-8">
                        @csrf
                                        ...
                                        <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-yellow-50' }}">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                                <div class="inline-flex items-center gap-2">
                                                    ...
                                                    <form
                                                        action="{{ route('pentadbir.peringkat_sumbangan.destroy', $row->id) }}"
