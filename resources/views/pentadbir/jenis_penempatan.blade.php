        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-6">Tambah - Jenis Penempatan</h3>
                    ...
                    <!-- Add Form -->
                    <form method="POST" action="{{ route('pentadbir.jenis_penempatan') }}" class="mb-8">
                        @csrf
                        <div class="space-y-4">
                            <div class="bg-yellow-50 p-4 rounded-md">
                                <label for="kod" class="block text-sm font-medium text-gray-700 mb-2">Kod</label>
                                <input type="text" name="kod" id="kod" maxlength="10" required
