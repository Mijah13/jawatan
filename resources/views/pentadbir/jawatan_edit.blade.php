<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Pentadbir Sistem - Kemaskini Jawatan') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-8 bg-gray-50 p-6 rounded-lg border border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Kemaskini Jawatan</h3>
                        <form action="{{ route('pentadbir.jawatan.update', $item->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="jawatan" class="block mt-1 w-full" type="text" name="jawatan"
                                        :value="old('jawatan', $item->jawatan)" required autofocus />
