...
<div class="col-lg-12 bg-light-gray"> 
    <div class="card bg-light-gray">
        <div class="card-header bg-light-gray" style="font-size:large; font-weight:bold;">
            <h1>Permohonan Tempahan -Fasiliti</h1>
        </div>
...
<?php
$changeStatusPelulus = Url::to(['tempah-fasiliti/change-status-pelulus']);
...
$(document).ready(function() {
    $(".change-status").click(function() {
        ...
        var status = $(this).data("status");
         ...
         showConfirmModal('Adakah anda pasti ingin mengubah status tempahan ini?', function () {
            $("#loading-overlay").show();

            
            $.ajax({
                url: '/tempah-fasiliti/change-status-pelulus?id=' + id,
                type: 'POST',
                data: {
                    id: id,
