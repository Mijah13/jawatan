...
/** @var app\models\JenisAsramaSearch $searchModel */
...
?>
<div class="jenis-asrama-index">

     <!-- Add Button -->
     <div class="text-right mb-3">
        <?= Html::a('<i class="bi bi-plus-circle"></i> <span class="fw-normal">Tambah Jenis Asrama</span>', ['create'], ['class' => 'btn btn-success shadow-sm text-white']) ?>
    </div>
