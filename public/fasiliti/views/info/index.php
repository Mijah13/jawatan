...
/** @var app\models\InfoSearch $searchModel */
...
<div class="info-index">
    ...
    <!-- Add Button -->
     <div class="text-right mb-3">
        <?= Html::a('<i class="bi bi-plus-circle"></i> <span class="fw-normal">Tambah Info</span>', ['create'], ['class' => 'btn btn-success shadow-sm text-white']) ?>
    </div>
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) {
                        return $model->aktif == 1 ? 'Aktif' : 'Tidak Aktif';
                    },
                    'filter' => [
                        1 => 'Aktif',
                        0 => 'Tidak Aktif'
